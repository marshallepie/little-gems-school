...
export default async function TeacherPage() {
  ...
  return <main className="mx-auto max-w-6xl space-y-6">
    ...
    <nav className="flex flex-wrap gap-3" aria-label="Teacher workflow links"><a className="min-h-11 rounded border px-4 py-3 font-semibold" href="/teacher/assignments">Assignments</a><a className="min-h-11 rounded border px-4 py-3 font-semibold" href="/teacher/assessments">Assessments and draft results</a><a className="min-h-11 rounded border px-4 py-3 font-semibold" href="/teacher/attendance">Attendance</a></nav><FutureFeatureNote>Lesson plans and messaging are not available in this phase.</FutureFeatureNote>
  </main>;
}
