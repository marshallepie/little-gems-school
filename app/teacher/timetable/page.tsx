...
export default async function TeacherTimetablePage() {
  ...
  if (teacherError) return <main className="mx-auto max-w-5xl space-y-6"><PortalHeader role="teacher" eyebrow="Teacher" title="My timetable"><p>Your timetable could not be loaded.</p></PortalHeader><UnavailableDashboardState /></main>;
  if (!teacher || teacher.employment_status !== "active") return <main className="mx-auto max-w-5xl space-y-6"><PortalHeader role="teacher" eyebrow="Teacher" title="My timetable"><p>Your teacher record is not active.</p></PortalHeader><EmptyDashboardState title="No active teacher record">Ask an administrator to link and activate your teacher record.</EmptyDashboardState></main>;
