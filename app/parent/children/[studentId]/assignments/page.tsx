...
export default async function ChildAssignmentsPage({ params }: { params: Promise<{ studentId: string }> }) {
  ...
  if (guardianError) return <main className="mx-auto max-w-5xl space-y-6"><PortalHeader role="parent" eyebrow="Parent" title="Child assignments"><p>Assignments could not be loaded.</p></PortalHeader><UnavailableDashboardState /></main>;
  ...
  if (linkError) return <main className="mx-auto max-w-5xl space-y-6"><PortalHeader role="parent" eyebrow="Parent" title="Child assignments"><p>Assignments could not be loaded.</p></PortalHeader><UnavailableDashboardState /></main>;
  if (!link) notFound();
  ...
  if (enrolmentError) return <main className="mx-auto max-w-5xl space-y-6"><PortalHeader role="parent" eyebrow="Parent" title="Child assignments"><p>Assignments could not be loaded.</p></PortalHeader><UnavailableDashboardState /></main>;
