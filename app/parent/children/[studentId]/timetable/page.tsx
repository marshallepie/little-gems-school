...
export default async function ChildTimetablePage({ params }: { params: Promise<{ studentId: string }> }) {
  ...
  if (guardianError) return <main className="mx-auto max-w-5xl space-y-6"><PortalHeader role="parent" eyebrow="Parent" title="Child timetable"><p>The timetable could not be loaded.</p></PortalHeader><UnavailableDashboardState /></main>;
  ...
  if (linkError) return <main className="mx-auto max-w-5xl space-y-6"><PortalHeader role="parent" eyebrow="Parent" title="Child timetable"><p>The timetable could not be loaded.</p></PortalHeader><UnavailableDashboardState /></main>;
  if (!link) notFound();
  ...
  if (enrolmentsError) return <main className="mx-auto max-w-5xl space-y-6"><PortalHeader role="parent" eyebrow="Parent" title="Child timetable"><p>The timetable could not be loaded.</p></PortalHeader><UnavailableDashboardState /></main>;
