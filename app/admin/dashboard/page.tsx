  ...
  return <main className="mx-auto max-w-6xl space-y-6">
    ...
    <DashboardCard title="Administration">
      ...
      <div className="flex flex-col gap-3 sm:flex-row">
        ...
        <Link className="inline-flex min-h-11 items-center justify-center rounded-lg border border-[color:var(--gem)] px-4 py-2 font-semibold no-underline" href={"/admin/admissions" as never}>Review admissions applications</Link>
