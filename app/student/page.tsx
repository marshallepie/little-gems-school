...
export default async function StudentPage() {
  ...
  return <main className="mx-auto max-w-4xl space-y-6">
    ...
    <nav className="flex flex-wrap gap-3" aria-label="Student workflow links"><a className="min-h-11 rounded border px-4 py-3 font-semibold" href="/student/assignments">My assignments</a><a className="min-h-11 rounded border px-4 py-3 font-semibold" href="/student/results">My results</a><a className="min-h-11 rounded border px-4 py-3 font-semibold" href="/student/attendance">My attendance</a></nav><FutureFeatureNote>Lessons and messaging are not available in this phase.</FutureFeatureNote>
  </main>;
}
