...
export default async function StudentAssignmentsPage() {
  ...
  if (studentError) return <main className="mx-auto max-w-5xl space-y-6"><PortalHeader role="student" eyebrow="Student" title="My assignments"><p>Assignments could not be loaded.</p></PortalHeader><UnavailableDashboardState /></main>;
  if (!student) return <main className="mx-auto max-w-5xl space-y-6"><PortalHeader role="student" eyebrow="Student" title="My assignments"><p>Your student record is not linked.</p></PortalHeader><EmptyDashboardState title="No student record">Ask an administrator to link your school record.</EmptyDashboardState></main>;
  ...
  if (enrolmentError) return <main className="mx-auto max-w-5xl space-y-6"><PortalHeader role="student" eyebrow="Student" title="My assignments"><p>Assignments could not be loaded.</p></PortalHeader><UnavailableDashboardState /></main>;
