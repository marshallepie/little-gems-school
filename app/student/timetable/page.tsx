...
export default async function StudentTimetablePage() {
  ...
  if (studentError) return <main className="mx-auto max-w-5xl space-y-6"><PortalHeader role="student" eyebrow="Student" title="My timetable"><p>Your timetable could not be loaded.</p></PortalHeader><UnavailableDashboardState /></main>;
  if (!student) return <main className="mx-auto max-w-5xl space-y-6"><PortalHeader role="student" eyebrow="Student" title="My timetable"><p>Your student record is not linked.</p></PortalHeader><EmptyDashboardState title="No student record">Ask an administrator to link your school record.</EmptyDashboardState></main>;
